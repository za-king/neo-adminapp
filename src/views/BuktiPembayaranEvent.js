...
function BuktiPembayaranEvent() {
  ...
  useEffect(() => {
    axios.get(`${process.env.REACT_APP_BASE_URL}/buktievent`,{headers: {
  ...
  const columns = [
    ...
    },
    {
      ...
      formatter: (rowContent, row) => {
        return (
          <div>
            <Link to={`/detailbuktievent/${row.id}`}>
...
export default BuktiPembayaranEvent;
